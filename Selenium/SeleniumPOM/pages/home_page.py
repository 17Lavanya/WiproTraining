...
class HomePage:
    ...
    SEARCH_BUTTON = (By.ID, "nav-search-submit-button")     #more than 1 value is packed here

    def __init__(self, driver):
        self.driver = driver
        self.wait = WebDriverWait(driver, 5)

    #(ACT) on homepage search
    ...
    def click_search_button(self):
        search_button = self.driver.find_element(*self.SEARCH_BUTTON)       #*means unpacking the SEARCH_BUTTON
        search_button.click()
